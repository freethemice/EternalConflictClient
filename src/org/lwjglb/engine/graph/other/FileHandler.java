...
public class FileHandler {
    public static FileHandler fileHandler  = new FileHandler(false);;

    private boolean isRelease;
    private final String devPath = "resources";
    ...
    public String getShader(String shaderName) {
        if (!isRelease)
            ...
            return releasePath + File.separator + "engine/shaders" + File.separator + shaderName + ".shader";
    }
    ...
    public String getModel(String name) {
        if (!isRelease)
            ...
            return releasePath + File.separator + "engine/models" + File.separator + name + ".obj";
    }
    ...
    private void saveModels() {
        System.out.println("Starting to copy over engine.models...");
        try {
            File Models = new File("engine/models");
            if (!Models.exists())
                Models.mkdir();
        ...
        System.out.println("Finished copying engine.models...");
    }
    ...
    private void saveShaders() {
        System.out.println("Starting to copy over engine.shaders...");
        try {
            File Shaders = new File("engine/shaders");
            if (!Shaders.exists())
                Shaders.mkdir();
        ...
        System.out.println("Finished copying engine.shaders...");
    }
