...
public class ShadowTestRenderer {
    ...
    private void setupTestShader() throws Exception {
        ...
        testShaderProgram.createVertexShader(Utils.loadResource("resources/shaders/test_vertex.vs"));
        testShaderProgram.createFragmentShader(Utils.loadResource("resources/shaders/test_fragment.fs"));
